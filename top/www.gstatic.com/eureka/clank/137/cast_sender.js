...
*/
    ...
    ;var xa = globalThis.trustedTypes, y;
    function ya() {
        var a = null;
        if (!xa)
            return a;
    ...
    var Fa = function(a) {
        ...
        return a.replace(Ea, function(d, e) {
            ...
            if (!h) {
                ...
                h = new A(h);
                if (c.nodeType === 1 && (e = c.tagName,
                /^(script|style)$/i.test(e)))
                    throw d = e.toLowerCase() === "script" ? "Use setScriptTextContent with a SafeScript." : "Use setStyleTextContent with a SafeStyleSheet.",
                    Error(d);
                if (h instanceof A)
                    h = h.g;
                else
    ...
    chrome.cast.hb = function(a, b, c, d) {
        this.label = a;
        a = b;
        ua.test(a) && (a.indexOf("&") != -1 && (a = a.replace(oa, "&amp;")),
    ...
    f.Jb = function() {
        if (this.breakStatus && this.breakStatus.currentBreakTime !== void 0)
            return this.playerState == chrome.cast.media.A.PLAYING && this.g >= 0 ? this.breakStatus.currentBreakTime + (Date.now() - this.g) / 1E3 : this.breakStatus.currentBreakTime
    }
    ;
    f.Ib = function() {
        if (this.breakStatus && this.breakStatus.currentBreakClipTime !== void 0)
            return this.playerState == chrome.cast.media.A.PLAYING && this.g >= 0 ? this.breakStatus.currentBreakClipTime + (Date.now() - this.g) / 1E3 : this.breakStatus.currentBreakClipTime
    }
    ;
    f.Kb = function() {
    ...
    K.prototype.delete = function(a) {
        return M(this.i, a) ? (delete this.i[a],
        --this.size,
        this.l++,
    ...
    var Wa = function() {
      ...
      , Za = function(a, b) {
        ...
        for (var d in b)
            d == "media" ? c.media = b.media.map(function(e) {
                e = Ya(a, e);
                e.s = !1;
                e.l = !0;
                return e
      ...
      , Ya = function(a, b) {
        ...
        for (var e in b)
            e != "items" && b.hasOwnProperty(e) && (e == "volume" ? (a.volume.level = b.volume.level,
        ...
        if (a.playerState == chrome.cast.media.A.IDLE && a.loadingItemId == null)
            a.currentItemId = null,
            a.loadingItemId = null,
            a.preloadedItemId = null,
            a.items = null;
    ...
    var V = function() {
      ...
      , W = function(a, b, c, d) {
        c && Pa(a.R, c);
        d !== void 0 ? b.sequenceNumber = d : (b.sequenceNumber = a.i,
        a.i = (a.i + 1) % 9007199254740992);
        d = Ra(a.B, b);
        c && d && (a = Qa(a.R, b.sequenceNumber)) && (a = a.g,
    ...
    V.prototype.initialize = function(a, b) {
        ...
        ,
        this.ha = (r.navigator || null).presentation.defaultRequest = a,
    ...
    var X = function(a, b) {
        ...
        var e = b.dialRequest;
        e && (c = e.appName,
        (d = e.launchParameter) && !d.match(hb) && (d = db(d)));
        var h = [];
        h.push({
            appId: b.appId,
    ...
    var ib = function(a, b, c, d, e, h, k) {
        d.type = c;
        b != null && (d.mediaSessionId = b.mediaSessionId,
        d.sessionId = b.sessionId);
        a.Ca(d, function(m) {
            m.status && m.status.length == 1 ? e && e(m.status[0]) : (m = new chrome.cast.Error(chrome.cast.v.SESSION_ERROR),
            h && h(m))
        }, h, k)
    };
    f = V.prototype;
    ...
    V.prototype.onMessage = function(a) {
        ...
        if (b = Qa(this.R, a.sequenceNumber))
    ...
    ;
    document.readyState == "complete" ? chrome.cast.da() : (window.addEventListener("load", chrome.cast.da, !1),
